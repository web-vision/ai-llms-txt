...
**Product:** LLMS TXT Generator
**Reference:** DoC-ai_llms_txt-0.3.0

## 1. Product identification

- **Product name:** LLMS TXT Generator
- **Type:** TYPO3 Extension
- **Extension key / package:** ai_llms_txt (web-vision/ai-llms-txt)
- **Version:** 0.3.0 (initial issuance of this declaration)
- **Valid for:** version 0.3.0 and subsequent releases, until superseded by a new declaration issued for a later substantial modification (Art. 3(30) CRA)
- **Distribution channels:** TYPO3 Extension Repository (TER) — https://extensions.typo3.org/extension/ai_llms_txt; Packagist — https://packagist.org/packages/web-vision/ai-llms-txt
...
LLMS TXT Generator, version 0.3.0, as distributed via the TYPO3
